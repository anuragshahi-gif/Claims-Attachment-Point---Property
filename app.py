...
st.divider()
st.caption("""
🔒 **Data Privacy Notice:** This tool processes data exclusively in your browser's temporary session memory. 
No data is saved to a server, database, or third-party storage. 
Your data is permanently wiped when you click 'Reset', refresh the page, or close this tab.
""")
